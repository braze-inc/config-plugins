...
exports.getFacebookAdvertiserIDCollection = exports.getFacebookAutoLogAppEvents = exports.getFacebookAutoInitEnabled = exports.getFacebookDisplayName = exports.getFacebookScheme = exports.getFacebookAppId = exports.getMergePropsWithConfig = void 0;
function getMergePropsWithConfig(config, props) {
    ...
    const { appID = facebookAppId, displayName = facebookDisplayName, scheme = facebookScheme !== null && facebookScheme !== void 0 ? facebookScheme : (appID ? `fb${appID}` : undefined), isAutoInitEnabled = facebookAutoInitEnabled, autoLogAppEventsEnabled = facebookAutoLogAppEventsEnabled, advertiserIDCollectionEnabled = facebookAdvertiserIDCollectionEnabled, } = (props !== null && props !== void 0 ? props : {});
    return {
        appID,
        displayName,
        scheme,
